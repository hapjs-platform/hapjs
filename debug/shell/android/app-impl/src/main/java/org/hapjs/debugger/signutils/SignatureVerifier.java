...
public class SignatureVerifier {
    ...
    public static X509Certificate[][] verify(String apkFile)
        ...
        try (RandomAccessFile apk = new RandomAccessFile(apkFile, "r")) {
            ...
            if (platformSignatureInfo != null) {
                X509Certificate[][] certificates = verifyPlatformSignature(apk, platformSignatureInfo);
                ...
                FileListSignatureVerifier.verify(new File(apkFile), fileListSignatureInfo, certificates[0][0]);
                return certificates;
            }
    ...
    private static void verifyIntegrity(
            ...
            long eocdOffset,
            ByteBuffer eocdBuf,
            boolean smallChunk) throws SecurityException {
        ...
        try {
            actualDigests =
                    computeContentDigests(
                            digestAlgorithms,
                            new DataSource[] {beforeApkSigningBlock, centralDir, eocd}, smallChunk);
    ...
    private static byte[][] computeContentDigests(
            ...
            DataSource[] contents, boolean smallChunk) throws DigestException {
    ...
    static class SigningBlockInfo {
        ...
        private SignatureInfo getPlatformSignatureInfo() {
            ...
            if (result != null) {
                return new SignatureInfo(result, this, id == BLOCK_ID_PLATFORM_SIGNATURE_SMALL_CHUNK);
            } else {
                return null;
            }
        }
    ...
    private static final class MemoryMappedFileDataSource implements DataSource {
        ...
        public void feedIntoMessageDigests(
            ...
            try {
                ...
                MappedByteBuffer buf = fileChannel.map(FileChannel.MapMode.READ_ONLY, filePosition, size);
