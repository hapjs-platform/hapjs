...
public class DumperContext {
    ...
    /**
     * Construct a new context instance using a new set of remaining arguments after invoking {@link
    ...
    /**
     * Access the caller's stdin input stream. This stream should only be read once (do not rely on it
     * having been buffered fully).
     */
