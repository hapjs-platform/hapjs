...
public interface AsyncPrettyPrinterFactory {
     ...
     *
     * @param headerName  header name of a response which is used to associate with an asynchronous
     *                    pretty printer
     * @param headerValue header value of a response which contains the URI for the schema data needed
     *                    to pretty print the response body
