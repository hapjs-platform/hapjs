...
public interface HighlightableDescriptor<E> {
    ...
    /**
     * Return the {@link View} to highlight or null if this element cannot be highlighted. If the
     * element does not span the full bounds of the returned {@link View} you can set the bounds of
     * the passed in Rect. By default the passed in bounds are empty which means highlight the full
     * bounds of the {@link View}.
     */
    @Nullable
