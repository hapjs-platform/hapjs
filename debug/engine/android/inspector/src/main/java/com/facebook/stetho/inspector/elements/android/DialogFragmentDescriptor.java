...
final class DialogFragmentDescriptor extends Descriptor<Object>
    ...
    public void getChildren(Object element, Accumulator<Object> children) {
        /**
         * We do NOT want the children from our super-{@link Descriptor}, which is probably {@link
         * FragmentDescriptor}. We only want to emit the {@link Dialog}, not the {@link View}.
