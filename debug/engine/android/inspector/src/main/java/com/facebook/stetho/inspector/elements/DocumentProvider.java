...
/**
 * Provides a document that can be rendered in Chrome's Elements tab (conforming loosely to the W3C
 * DOM to the degree specified in this API).
 *
...
public interface DocumentProvider extends ThreadBound {
    ...
    // INSPECTOR ADD
    void setAttributesAsText(Object element, String name, String text);
}
