...
public final class ListUtil {
    ...
    public static <T> List<T> copyToImmutableList(List<T> list) {
        ...
        switch (size) {
            ...
            case 4:
                return new FourItemImmutableList<>(list.get(0), list.get(1), list.get(2),
                        list.get(3));
            case 5:
    ...
    private static final class ImmutableArrayList<E> extends AbstractList<E>
    ...
    private static final class OneItemImmutableList<E> extends AbstractList<E>
            implements ImmutableList<E> {
    ...
    private static final class TwoItemImmutableList<E> extends AbstractList<E>
            implements ImmutableList<E> {
    ...
    private static final class ThreeItemImmutableList<E> extends AbstractList<E>
            implements ImmutableList<E> {
        private final E mItem0;
        private final E mItem1;
    ...
    private static final class FourItemImmutableList<E> extends AbstractList<E>
            implements ImmutableList<E> {
        private final E mItem0;
        private final E mItem1;
        private final E mItem2;
    ...
    private static final class FiveItemImmutableList<E> extends AbstractList<E>
            implements ImmutableList<E> {
        private final E mItem0;
        private final E mItem1;
        private final E mItem2;
