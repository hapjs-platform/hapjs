...
public class ProcessUtil {
     ...
     *
     * @return Process name or null if there was an error reading from {@code /proc/self/cmdline}. It
     * is unknown how this error can occur in practice and should be considered extremely rare.
     */
    @Nullable
