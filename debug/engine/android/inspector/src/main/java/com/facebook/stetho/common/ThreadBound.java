...
/**
 * Implemented by an object whose methods must be called on a specific thread. If a method is called
 * from a disallowed thread then {@link java.lang.IllegalStateException} will be thrown. To marshal
 * a call to the correct thread, you can use {@link #postAndWait(UncheckedCallable)} or {@link
...
public interface ThreadBound {
     ...
     *
     * @throws java.lang.IllegalStateException if the current thread does not have access to this
     *                                         object
     */
    ...
    /**
     * Asynchronously executes a {@link Runnable} on the thread that this object is bound to after the
     * specified delay.
     *
     * @param r           the {@link Runnable} to execute
