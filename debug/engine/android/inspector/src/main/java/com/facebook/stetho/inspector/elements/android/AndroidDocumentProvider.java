...
final class AndroidDocumentProvider extends ThreadBoundProxy
    ...
    public AndroidDocumentProvider(
            Application application, List<DescriptorProvider> descriptorProviders,
    ...
    private void getWindows(final Accumulator<Window> accumulator) {
        ...
        if (appDescriptor != null) {
            Accumulator<Object> elementAccumulator =
            ...
            public boolean onTouchEvent(MotionEvent event) {
                ...
                while (true) {
                    ...
                    final Object element =
                            descriptor.getElementToHighlightAtPosition(elementToHighlight, x, y,
                                    mHitRect);
                    ...
                    if (descriptor != null) {
                        final View viewToHighlight =
                                descriptor.getViewAndBoundsForHighlighting(
                                        elementToHighlight, mHighlightingBoundsRect);

                        if (event.getAction() != MotionEvent.ACTION_CANCEL) {
                            if (viewToHighlight != null) {
                                mHighlighter.setHighlightedView(
                                        viewToHighlight, mHighlightingBoundsRect,
                                        INSPECT_HOVER_COLOR);
