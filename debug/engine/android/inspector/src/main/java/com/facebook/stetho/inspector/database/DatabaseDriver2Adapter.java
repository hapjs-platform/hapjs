...
/**
 * @deprecated Use {@link DatabaseDriver2} directly. This is provided only for legacy drivers to be
 * adapted internally within Stetho.
 */
@Deprecated
public class DatabaseDriver2Adapter
    ...
    public Database.ExecuteSQLResponse executeSQL(
            StringDatabaseDescriptor database, String query, ExecuteResultHandler handler)
