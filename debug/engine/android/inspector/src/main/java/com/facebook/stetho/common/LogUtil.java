...
public class LogUtil {
     ...
     * This interface is sometimes sidestepped to avoid Android's default fairly awkward {@link
     * Log#isLoggable(String, int)} interface from blocking important messages while still offering
     * users of Stetho to suppress our error/warning logs via {@link
     * LogRedirector#setLogger(LogRedirector.Logger)}.
     */
