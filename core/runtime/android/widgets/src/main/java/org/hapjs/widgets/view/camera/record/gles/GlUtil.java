...
public class GlUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program == 0) {
            Log.e(TAG, CameraBaseMode.VIDEO_RECORD_TAG + "Could not create program");
        }
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            Log.e(TAG, CameraBaseMode.VIDEO_RECORD_TAG + "Could not link program: ");
            Log.e(TAG, CameraBaseMode.VIDEO_RECORD_TAG + GLES20.glGetProgramInfoLog(program));
    ...
    public static int loadShader(int shaderType, String source) {
        ...
        if (compiled[0] == 0) {
            Log.e(TAG, CameraBaseMode.VIDEO_RECORD_TAG + "Could not compile shader " + shaderType
                    + ":");
        ...
        if (location < 0) {
            Log.e(
                    ...
                    CameraBaseMode.VIDEO_RECORD_TAG
                            + "checkLocation Unable to locate '"
                            + label
                            + "' in program");
        }
    }
