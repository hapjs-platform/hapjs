...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        if (mProgramHandle == 0) {
            Log.e(TAG,
                    CameraBaseMode.VIDEO_RECORD_TAG + "Texture2dProgram Unable to create program");
            return;
        }
    ...
    public void setTexSize(int width, int height) {
        ...
        mTexOffset =
                new float[] {-rw, -rh, 0f, -rh, rw, -rh, -rw, 0f, 0f, 0f, rw, 0f, -rw, rh, 0f, rh,
                        rw, rh};
     ...
     * @param vertexStride    Width, in bytes, of the position data for each vertex (often vertexCount *
     *                        sizeof(float)).
     * @param texMatrix       A 4x4 transformation matrix for texture coords. (Primarily intended for use
     *                        with SurfaceTexture.)
    ...
    public boolean draw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex,
        ...
        synchronized (sLock) {
            ...
            isError = GlUtil.checkGlError("glUseProgram");
            ...
            isError = GlUtil.checkGlError("glUniformMatrix4fv") || isError;
            ...
            if (muKernelLoc >= 0 && null != mKernel && null != mTexOffset) {
