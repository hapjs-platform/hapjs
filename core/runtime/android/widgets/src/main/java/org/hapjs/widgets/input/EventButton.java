...
import static org.hapjs.statistics.StatisticsProvider.KEY_RPK_PACKAGE;
import static org.hapjs.statistics.StatisticsProvider.KEY_RPK_VERSION;
...
public class EventButton extends Button {
    ...
    private void reportTraceEvent(String type) {
        if (null != mContext) {
            StatisticsProvider statisticsProvider = (StatisticsProvider) ProviderManager.getDefault()
                    .getProvider(StatisticsProvider.NAME);
            if (null != statisticsProvider) {
                ...
                statisticsProvider.recordCountEvent(packageName, "", type, reportParams);
            }
    ...
    public void fireGestureEvent(int createCode, String eventName, Map<String, Object> data, boolean immediately, String rpkName) {
        ...
        ThreadUtils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                reportTraceEvent(RuntimeStatisticsManager.KEY_APP_EVENT_BUTTON_CLICK);
            }
        });
    }
