 ...
 *       {@link #endArray} and every call to {@link #object} must have a matching call to {@link
 *       #endObject}.
 ...
 *
 * <p>This class provides no facility for pretty-printing (ie. indenting) output. To encode indented
 * output, use {@link JSONObject#toString(int)} or {@link JSONArray#toString(int)}.
 *
 * <p>Some implementations of the API support at most 20 levels of nesting. Attempts to create more
 * than 20 levels of nesting may fail with a {@link JSONException}.
 *
 * <p>Each stringer may be used to encode a single top level value. Instances of this class are not
...
public class JSONStringer {
     ...
     *
     * <p>If invoked with unterminated arrays or unclosed objects, this method's return value is
     * undefined.
     *
     * <p><strong>Warning:</strong> although it contradicts the general contract of {@link
     * Object#toString}, this method returns null if the stringer contains no data.
     */
    @Override
