...
@ModuleExtensionAnnotation(
        ...
        actions = {
                ...
                @ActionAnnotation(name = PageModule.ACTION_SET_TABBAR_DATA, mode = Extension.Mode.SYNC)
        }
)
public class PageModule extends ModuleExtension {
    ...
    protected static final String ACTION_SET_TABBAR_DATA = "setTabBarItem";
    ...
    public Response invokeInner(Request request) throws Exception {
        ...
        } else if (ACTION_SET_TABBAR_DATA.equals(action)) {
