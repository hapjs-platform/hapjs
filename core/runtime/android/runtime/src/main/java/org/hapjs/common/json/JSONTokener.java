 ...
 * the corresponding object. Most clients of this class will use only need the {@link
 * #JSONTokener(String) constructor} and {@link #nextValue} method. Example usage:
 *
 * <pre>
 * String json = "{"
 *         + "  \"query\": \"Pizza\", "
 ...
 *
 * <p>For best interoperability and performance use JSON that complies with RFC 4627, such as that
 ...
 * </ul>
 *
 * <p>Each tokener may be used to parse a single JSON string. Instances of this class are not thread
...
public class JSONTokener {
    private static final String TAG = "JSONTokener";
    ...
    private Object readLiteral() throws JSONException {
        ...
        if (literal.indexOf('.') == -1) {
            ...
            try {
                 ...
                 */
                Log.e(TAG, "read literal error", e);
            }
        }
        ...
        try {
            ...
            Log.e(TAG, "read literal error", ignored);
        }
        ...
        while (true) {
            ...
            if (!(name instanceof String)) {
                if (name == null) {
                    ...
                    throw syntaxError(
                            "Names must be strings, but " + name + " is of type "
     ...
     *
     * <p>The returned string shares its backing character array with this tokener's input string. If
     * a reference to the returned string may be held indefinitely, you should use {@code new
