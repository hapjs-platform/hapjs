 ...
 * {@link JSONObject#NULL}. Values may not be {@link Double#isNaN() NaNs}, {@link
 * Double#isInfinite() infinities}, or of any type not listed here.
 *
 * <p>{@code JSONArray} has the same type coercion behavior and optional/mandatory accessors as
...
public class JSONArray {
     ...
     *              {@link JSONObject#NULL}, or {@code null}. May not be {@link Double#isNaN() NaNs} or {@link
     *              Double#isInfinite() infinities}. Unsupported values are not permitted and will cause the
     ...
     * length if necessary. If a value already exists at {@code index}, it will be replaced.
     *
     * @return this array.
     */
     ...
     *                       {@code null} reference. This method returns normally if the value is {@code
     *                       JSONObject#NULL}.
     */
    ...
    /**
     * Removes and returns the value at {@code index}, or null if the array has no value at {@code
     * index}.
     */
    ...
    /**
     * Returns the value at {@code index} if it exists, coercing it if necessary. Returns {@code
     * fallback} if no such value exists.
     */
     ...
     *
     * @throws JSONException if the value doesn't exist or is not a {@code JSONArray}.
     */
    ...
    /**
     * Returns the value at {@code index} if it exists and is a {@code JSONArray}. Returns null
     * otherwise.
     */
    ...
    /**
     * Returns the value at {@code index} if it exists and is a {@code JSONObject}. Returns null
     * otherwise.
     */
    ...
    /**
     * Returns a new string by alternating this array's values with {@code separator}. This array's
     * string values are quoted and have their special characters escaped. For example, the array
