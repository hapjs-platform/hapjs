...
public class TextureRender {
    ...
    private SwRenderMatrixCorrector swRenderMatrixCorrector;
    ...
    public TextureRender() {
        ...
        swRenderMatrixCorrector = new SwRenderMatrixCorrector();
    ...
    public void makeSWRenderMatrix(MediaFormat format, int rotate) {
        isSwRender = true;
        swRenderMatrixCorrector.createSwRenderMatrix(format, rotate);
    }
    ...
    public void drawFrame(SurfaceTexture st) {
        ...
        if (isSwRender) {
            swRenderMatrixCorrector.modifyMatrixIfNeeded(mSTMatrix);
        } else {
