...
public class InputSurface {
    ...
    private void eglSetup() {
        ...
        int[] attribListTemp = {EGL14.EGL_CONTEXT_CLIENT_VERSION, 2, EGL14.EGL_NONE};
        mEGLContext =
                EGL14.eglCreateContext(mEGLDisplay, configs[0], EGL14.EGL_NO_CONTEXT, attribListTemp,
                        0);
    ...
    /**
     * Discard all resources held by this class, notably the EGL context. Also releases the Surface
